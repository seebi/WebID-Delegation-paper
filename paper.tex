...
\todo{maybe another name here? (A:Agent and delegatedAgent maybe?)}
...
\subsection{Basic Use-Cases for Access Delegation}\label{sec:usecases}\todo{A: IMHO two major cases, 'attended' and 'unattended'}
...
\todo{A: how is this different from the prev. case?}
