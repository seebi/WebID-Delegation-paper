...
%Currently, those information needs to be publicly available, which leads to an privacy issue, since agents may want to hide such information from the general audience.
...
This extends the range of application scenarios where WebID authentication can be deployed to all kinds of server to server resource consumption scenarios and other use cases.  
\end{abstract}
