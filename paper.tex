...
The technical solution for this concept annotates HTTP requests by adding the \lstinline|X-On-Behalf-Of| header field which refers to the WebID of the user in whose name the agent acts.
