...
In this paper we explore different ways how an agent can act as a user and we propose an extension to the WebID protocol which allows for delegation of access authorization from a WebID to a third party, e.g. allowing a server to be able to act on behalf of its users.
...
The solution we will propose will be based on the following general principles:
