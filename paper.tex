...
\begin{abstract}
The WebID protocol enables global identification of agents in a distributed manner by combining asymmetric cryptography and Linked Data.
...
As a prerequisite for deciding whether access should be granted or denied, the web server itself needs to retrieve other WebID profiles and linked resources in order to work out if the requesting agent is part of the authorization group (e.g. is a friends of a friend of the resource owner).
...
But there is a privacy issue involved here: not everyone wants to make all of their social network publically visible, and some may not want to make any of it publicly visible.
