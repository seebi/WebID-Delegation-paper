...
MyProfile intends to provide a solution for managing the numerous accounts and profiles that users have on the Web.
...
\begin{figure*}[htb]
  \centering
  \includegraphics[width=\textwidth]{AuthSequence}
  \caption{The MyProfile dashboard visualizes information from different sources fetched by the MyProfile server as a secretary of its user}
  \label{fig:MyProfile}
\end{figure*}
